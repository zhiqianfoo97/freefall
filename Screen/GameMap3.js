...
import Systems from '../src/system3';
  ...
  render() {
    return (
      <View style={styles.container}>
        <ImageBackground source={require("../Image/martian.jpg")} style={styles.backgroundImageAnim}>
        <GameEngine
          ref={ref => {
            this.gameEngine = ref;
          }}
        ...
        {!this.state.gameOv ? (
          <View style={styles.scoreView}>
             <View style = {styles.headerWrapper}>
                  ...
                  <Text style={styles.velocity}>v = 278m/s</Text>
                  <Text style={styles.gravity}>g = 3.7m/s^2</Text>
                </View>
